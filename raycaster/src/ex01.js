...
// classing mesh that got hit with a ray
...
export default function example() {
	...
	function draw() {
		...
		boxMesh.material.color.set('white');
		torusMesh.material.color.set('white');
		...
		const intersects = raycaster.intersectObjects(meshes).forEach(item => {
